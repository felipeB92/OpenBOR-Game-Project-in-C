...
{ // Damage as throw finisher
   ...
   if(target!=NULL())
   {
     ...
     if(Type==3)
     {
       damageentity(target, self, 0, 1, openborconstant("ATK_NORMAL9")); // 3rd throw type
     }
...
{// Targetting opponent before leaping or dashing.  before = antes de
// Velx = x Velocity
// Velz = z Velocity
// dx = x added distance
// dz = z added distance
...
{// Targetting opponent before performing targetted leap attack
    ...
    float y = getentityproperty(self, "a"); // Get enemy's z coordinate
    ...
    if( getlocalvar("T"+self) != NULL()){ // Is there a target?
      ...
      float Ty = getentityproperty(target, "a"); // Get target's z coordinate
      float Disx = Tx - x;
      float Disz = Tz - z;
      float Disy = Ty - y;
      ...
      if( Disx <= 100 && Disz <= 50 && Disy <= 20){
        if(Tx < x){
          changeentityproperty(self, "direction", 0); // Face left
        } else {
          changeentityproperty(self, "direction", 1); // Face right
        }
        setlocalvar("x"+self, (Tx-x)/(10*Vy)); // Calculate Vx then store value in local variable
        setlocalvar("z"+self, (Tz-z)/(10*Vy)); // Calculate Vz then store value in local variable
...
{// Cancels attack if targetted player is fallen on ground
	...
	if(PAnim == openborconstant("ANI_pain2"))
	if(PAnim == openborconstant("ANI_pain"))
	if(PAnim == openborconstant("ANI_fall"))
	if(PAnim == openborconstant("ANI_grab"))
...
void cancelgrab()
        ...
        // If it's forbidden to grab him/her, revert to IDLE
           ...
           if(target!=NULL())
           {
             ...
             if(Tname == "Car" || Tname == "Car2" || Tname == "Car3" || Tname == "Car4" || Tname == "Car5" || Tname == "cartel" || Tname == "door" || Tname == "door0" || Tname == "bottle" || Tname == "ninja" || Tname == "AABOBO3" || Tname == "DragTor" || Tname == "DragTor" || Tname == "gw" || Tname == "robot_braso_iz" || Tname == "robot" || Tname == "garra" || Tname == "Lindal" || 

Tname == "megalodonte" || Tname == "Bolon" || Tname == "Lindal2" || Tname == "SChin" || Tname == "Matrix4" || Tname == "Matrix3" || Tname == "Matrix2" || Tname == "Linda4" || Tname == "vidrio" || Tname == "Harry" || Tname == "Mibobo" || Tname == "Burnovx22" || Tname == "fonola" || Tname == "punk" || iType == openborconstant
...
void cancelgrab2()
        ...
        // If it's forbidden to grab him/her, revert to IDLE
           ...
           if(target!=NULL())
           {
             ...
             if(Tname == "Car" || Tname == "Car2" || Tname == "Car3" || Tname == "Car4" || Tname == "Car5" || Tname == "cartel" || Tname == "door" || Tname == "door0" || Tname == "bottle" || Tname == "ninja" || Tname == "AABOBO3" || Tname == "bottle" || Tname == "DragTor" || Tname == "gw" || Tname == "robot_braso_iz" || Tname == "garra" || Tname == "robot" || Tname == "Lindal" || 

Tname == "megalodonte" || Tname == "Bolon" || Tname == "Lindal2" || Tname == "SChin" || Tname == "Matrix4" || Tname == "Matrix3" || Tname == "Matrix2" || Tname == "vidrio" || Tname == "Linda4" || Tname == "Harry" || Tname == "Mibobo" || Tname == "Burnovx22" || Tname == "punk" || iType == openborconstant
...
void cancelgrabrobot()
        ...
        // If it's forbidden to grab him/her, revert to IDLE
           ...
           if(target!=NULL())
           {
             ...
             if(Tname == "robot_braso_iz" || Tname == "robot" || Tname == "garra" || Tname == "Lindal" || 
